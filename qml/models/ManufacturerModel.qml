...
// XXX: Save and load these from somewhere
ListModel {
    id: manufacturerModel
    ListElement { manufacturer: ""; }

    ListElement { manufacturer: "Martela"; }
    ListElement { manufacturer: "Isku"; }
    ListElement { manufacturer: "IKEA"; }
